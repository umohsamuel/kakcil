    ...
    <div className="relative flex h-dvh flex-col overflow-hidden bg-white text-black">
      ...
      <main className="relative flex h-dvh w-full flex-col items-center justify-center">
        <div className="mx-auto max-w-5xl space-y-8 text-center">
          <h1 className="text-5xl font-black tracking-tighter md:text-8xl lg:text-8xl">
            Decisions by
            <br />
          ...
          <p className="mx-auto max-w-2xl text-xl leading-relaxed font-light text-gray-600 md:text-2xl">
